...
// list of all the methods in analytics.js that we want to stub
...
window.analytics.factory = function (method) {
	return function () {
var args = Array.prototype.slice.call(arguments); args.unshift(method); window.analytics.push(args);
...
window.analytics.load('vhqg44cry7');
